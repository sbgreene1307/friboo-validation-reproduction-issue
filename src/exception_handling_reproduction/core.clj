(ns exception-handling-reproduction.core
  (:require [com.stuartsierra.component :as component]
            ...
            [exception-handling-reproduction.api :as api])
  (:gen-class))
...
(def default-db-config
  {:db-classname       "org.postgresql.Driver"
   ...
   :db-subname         "//localhost:5432/exception-handling-reproduction"
   :db-user            "postgres"
   :db-password        "postgres"
   :db-init-sql        "SET search_path TO ehr_data, public"
